...
const ProductOverview = () => {
  ...
  if (isLoading) {
    return <div className="text-center py-6 text-xl font-semibold">Loading...</div>;
  }

  if (error || !product) {
    return <div className="text-center py-6 text-xl font-semibold text-red-500">Error loading product. Please try again later.</div>;
  }
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-2/3">
            {/* Product Name */}
            <h1 className="text-3xl md:text-4xl font-semibold text-gray-800 dark:text-gray-200">{product.title}</h1>
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <span className="text-gray-600 dark:text-gray-400">({product.rating.count} ratings)</span>
            </div>

            {/* Price Section */}
            <div className="flex items-center mt-4">
              <p className="text-2xl md:text-3xl font-semibold text-gray-800 dark:text-gray-200">₹{product.price}</p>
              <p className="text-gray-500 dark:text-gray-400 line-through ml-4">₹{(product.price * 1.5).toFixed(2)}</p>
            ...
            <div className="bg-blue-50 dark:bg-blue-900 border-l-4 border-blue-600 p-4 rounded mt-4 shadow-lg">
              <p className="text-blue-600 dark:text-blue-400 font-semibold text-lg">Special Offers:</p>
            ...
            {/* Specifications */}
            <div className="mt-6">
              <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200">Specifications:</h2>
...
/>
            ...
            <div className="flex items-center gap-2 mt-4">
              ...
              <p className="text-gray-600 dark:text-gray-300">Secure Payment and Easy Returns</p>
            </div>

            {/* Social Sharing */}
            <div className="flex gap-4 mt-6">
              <button className="text-gray-600 dark:text-gray-300 hover:text-blue-600 flex items-center gap-2 transition duration-300">
                <FaFacebook /> Facebook
              </button>
              <button className="text-gray-600 dark:text-gray-300 hover:text-blue-600 flex items-center gap-2 transition duration-300">
                <FaTwitter /> Twitter
        ...
        <div className="mt-12">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200">Customer Reviews</h2>
          <div className="mt-4">
            {[1, 2, 3].map((_, index) => (
              <div key={index} className="bg-gray-50 dark:bg-[#333333] p-4 rounded-lg shadow-md mb-4">
                <h3 className="font-semibold text-gray-800 dark:text-gray-200">John Doe</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">"This product is amazing! Highly recommended."</p>
              </div>
            ))}
          </div>
        </div>
