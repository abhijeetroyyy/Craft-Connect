        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="md:w-1/2 flex justify-center">
            <Image
              ...
              width={500}
              height={600}
              className="w-full max-w-sm h-[500px] object-cover rounded-lg shadow-lg transition-transform duration-300 hover:scale-105"
              loading="lazy"
          ...
          <div className="md:w-1/2 md:pl-8 text-center md:text-left">
            ...
            <button
              ...
              className="bg-yellow-500 hover:bg-yellow-600 text-white py-2 px-6 rounded-lg transition-transform duration-300 transform hover:scale-105"
            >
